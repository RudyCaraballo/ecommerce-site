...
export default function Categories() {
  const categories = [
    ...
    },
    {
      ...
      title: "Sneakers",
      imgUrl:
        "https://images.unsplash.com/photo-1552066344-2464c1135c32?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80",
    },
    {
      id: 3,
      title: "Jackets",
    ...
    },
    {
      ...
      title: "Womens",
      imgUrl:
        "https://images.unsplash.com/photo-1607749101678-01b521ae7900?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80",
    },
  ];
  ...
  return (
    <div className="categories-container">
      {categories.map((categoryObj) => (
        <Catagory key={categoryObj.id} obj={categoryObj} />
      ))}
    </div>
  );
};
